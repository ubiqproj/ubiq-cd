...
import (
	...
	http "net/http"
	strings "strings"
	v1 "ubiq-cd/internal/interface-adapter/interface/connectrpc/gen/api/v1"
)
...
var (
	greetServiceServiceDescriptor     = v1.File_api_v1_greet_proto.Services().ByName("GreetService")
